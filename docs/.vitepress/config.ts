...
export default defineConfig({
  title: 'Klexir.Lang',
  description: 'The Klexir programming language — a lexer, parser, type checker, and evaluator',
  base: '/Klexir.Lang/',
  cleanUrls: true,
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Klexir.Lang' }],
    ['meta', { property: 'og:description', content: 'The Klexir programming language — a lexer, parser, type checker, and evaluator' }],
  ],

  themeConfig: {
    siteTitle: 'Klexir.Lang',
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/Danny4897/Klexir.Lang' },
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Danny4897/Klexir.Lang' },
    ],
